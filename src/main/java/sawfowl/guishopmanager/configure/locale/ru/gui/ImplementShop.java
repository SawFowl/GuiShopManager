...
public class ImplementShop implements Shop {
	...
	@Setting("EditBuy")
	private Component editBuy = TextUtils.deserialize("&2Настройка покупки предмета");
	@Setting("EditSell")
	private Component editSell = TextUtils.deserialize("&2Настройка продажи предмета");
	@Setting("BuyTransaction")
	private Component buyTransaction = TextUtils.deserialize("&2Покупка");
	@Setting("SellTransaction")
	private Component sellTransaction = TextUtils.deserialize("&2Продажа");
